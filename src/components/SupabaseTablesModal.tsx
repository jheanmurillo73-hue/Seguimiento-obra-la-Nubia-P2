...
export const SupabaseTablesModal: React.FC<SupabaseTablesModalProps> = ({
  ...
  > = {
    ...
    v_resumen_redes: {
      name: 'v_resumen_redes (Vista SQL Consolidada por Sector y Acta)',
      description: 'Consolidación ejecutiva por Sector y Acta de Facturación, integrando cantidades planificadas (Línea Base), ejecutadas y % de avance físico.',
      icon: 'analytics',
      columns: [
        { name: 'sector_id', type: 'VARCHAR', constraints: "'I1' | 'I2' | 'TRONCAL'", description: 'Identificador único del sector' },
        { name: 'sector_nombre', type: 'VARCHAR', constraints: 'NOT NULL', description: 'Nombre descriptivo del sector o tramo' },
        { name: 'acta_numero', type: 'VARCHAR', constraints: "'Acta 1' | 'Acta 2' | 'Acta 3' | 'Sin Acta'", description: 'Código o número del acta' },
        { name: 'estado_acta', type: 'VARCHAR', constraints: "'Facturado' | 'En Revisión' | 'Pendiente por Facturar'", description: 'Estado del cobro / facturación' },
        { name: 'cantidad_planificada', type: 'NUMERIC', constraints: 'METROS LINEALES', description: 'Metros planificados según presupuesto/diseño' },
        { name: 'cantidad_ejecutada_acta', type: 'NUMERIC', constraints: 'METROS LINEALES', description: 'Metros reales reportados en el acta' },
        { name: 'porcentaje_avance_sector', type: 'NUMERIC', constraints: 'PORCENTAJE (0-100%)', description: 'Porcentaje estimado de avance físico' },
        { name: 'camaras_ejecutadas_acta', type: 'NUMERIC', constraints: 'UNIDADES PONDERADAS', description: 'Cámaras equivalentes ejecutadas' },
        { name: 'total_elementos', type: 'BIGINT', constraints: 'NOT NULL', description: 'Cantidad total de registros en el acta' },
        { name: 'fecha_corte_acta', type: 'DATE', constraints: 'YYYY-MM-DD', description: 'Fecha de cierre o corte del acta' },
      ],
    },
